  ...
  return (
    <section className="h-[55rem] xl:h-[40rem] bg-white flex flex-col items-center gap-10 relative w-full max-w-[1920px]">
      ...
      <div className="border-b-8 border-[#6FCADB] mt-5">
        <h3 className="translate-y-3 text-xl xl:text-3xl font-bold text-black">
          Veja alguns sorrisos transformados
        </h3>
      </div>
      ...
      <Carousel>
        <div className="flex items-center justify-center flex-wrap gap-10">
          <Image
            ...
            width={400}
            height={400}
            className="border-[#6FCADB] border-8 rounded"
          />
          <Image
            src={"/caroussel/2.jpg"}
            alt={"Resultado 1"}
      ...
      <Link href={linkWhatsAppComMensagem()}>
        <p className=" animate-pulse font-bold text-2xl xl:text-3xl text-white  flex gap-2 justify-center items-center bg-[#71CCDC] p-2 rounded-md">
