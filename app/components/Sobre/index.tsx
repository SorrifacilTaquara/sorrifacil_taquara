  ...
  return (
    <section className="w-screen max-w-[1920px] h-[23rem] xl:h-[55rem] 4xl:h-[75rem] relative z-">
      ...
      <div className="absolute  top-5 xl:top-[20%] right-[4%] xl:right-[8%] flex flex-col items-end z-10 xl:z-0 ">
        <h3 className="font-semibold text-2xl xl:text-4xl text-white mb-6 text-right">
          Sobre nós
        </h3>
        <p className="font-medium text-md xl:text-2xl text-white text-right">
          A Sorrifácil Taquara é uma Clínica <br />
          Odontológica que prioriza o bem-estar <br />e a confiança
