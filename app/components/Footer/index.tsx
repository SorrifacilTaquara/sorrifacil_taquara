    ...
    <footer className="bg-[#71CCDC] flex flex-col xl:flex-row items-center justify-around px-24 py-12 gap-3 xl:gap-0">
      ...
      <div className="flex flex-col items-center text-white -translate-y-[0.3rem]">
        ...
        <div className="mt-2 flex gap-3">
          <Link href={"https://wa.me/555198573027"} className="border border-white py-[0.20rem] px-[0.30rem] rounded-md">
            <WhatsAppIcon sx={{ fontSize: 18, color: "white" }} />
          </Link>
          <Link href={"https://www.instagram.com/sorrifacil_taquara/"} className="border border-white py-[0.20rem] px-[0.30rem] rounded-md">
