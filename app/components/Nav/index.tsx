    ...
    <header className="flex flex-row justify-center items-center h-16 w-full backdrop-blur bg-[#47619c5b]/5 fixed z-10">
      <nav className="w-[60%]">
        <ul className="flex flex-row justify-around ">
          ...
          <li className="text-white font-semibold cursor-pointer" onClick={() => scrollToSection("footer")}>
            Localização
          </li>
          <li className="text-white font-semibold cursor-pointer" onClick={() => scrollToSection("footer")}>
            Contato
      ...
      <div className="flex gap-4 ml-6">
        <Link href={"https://wa.me/555198573027"} className="border border-white py-[0.20rem] px-[0.30rem] rounded-md cursor-pointer">
          <WhatsAppIcon sx={{ fontSize: 18, color: "white" }} />
        </Link>
        <Link href={"https://www.instagram.com/sorrifacil_taquara/"} className="border border-white py-[0.20rem] px-[0.30rem] rounded-md cursor-pointer">
