    ...
    <section className="w-screen max-w-[1920px] h-[20rem] xl:h-[49rem] 4xl:h-[calc(63rem+5vh)] relative">
      {!props.isMobile ? (
        <>
          <Image
            ...
            height={"7920"}
            alt={"inicio"}
            className="w-[600px] 4xl:w-[900px] absolute bottom-0 right-0"
          />
          <Image
            src={"/fundo.png"}
            width={"1920"}
      ...
      <div className="absolute top-6 xl:top-[30%] left-[18%] xl:left-[8%] flex flex-col items-start ">
        ...
        <p className="w-[60%] xl:w-auto font-medium text-sm xl:text-1xl text-white ">
          Entre em contato agora mesmo pelo WhatsApp <br />e agende
          sua consulta de avaliação, estamos te esperando.
        </p>
        <Link href={linkWhatsAppComMensagem()}>
          <p className="animate-pulse font-bold text-md xl:text-2xl text-white mt-5 flex gap-2 justify-center items-center bg-[#4b8c9eb2] p-2 rounded-md">
            Agendar agora
          </p>
        </Link>
      </div>
